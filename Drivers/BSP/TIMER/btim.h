...
#define BTIM_TIMX_INT                       TIM1
#define BTIM_TIMX_INT_IRQn                  TIM1_UP_IRQn
#define BTIM_TIMX_INT_IRQHandler            TIM1_UP_IRQHandler
#define BTIM_TIMX_INT_CLK_ENABLE()          do{ __HAL_RCC_TIM1_CLK_ENABLE(); }while(0)   /* TIM1 时钟使能 */
